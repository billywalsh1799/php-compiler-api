...
$phpFile ="test.php";  // Replace with the actual path to your Python file
...
$executeCmd = "php $phpFile " .implode(' ', $arguments);
...
//old if statement to chech whter is recourse pipes 1 is mandatory
